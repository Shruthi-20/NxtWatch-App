...
export const GamingPage = styled.div`
    ...
    background-color: ${props =>
      props.theme.isDarkTheme ? '#0f0f0f' : '#f9f9f9'};
    width: 1200px;
    min-height: 100vh;
    height: auto;
`
...
export const GamingErrorInfo = styled.p`
    font-family: 'Roboto';
    font-size: 18px;
    color: ${props => (props.theme.isDarkTheme ? '#d7dfe9' : '#424242')};
    margin-bottom: 20px;
`
...
export const GamingHeadingContainer = styled.div`
    ...
    align-items: center;
    background-color: ${props =>
      props.theme.isDarkTheme ? '#181818' : '#f1f5f9'};
    margin-left: 0px;
    padding-left: 30px;
`
...
export const GamingResultContainer = styled.div`
    ...
    padding: 30px;
    background-color: ${props =>
      props.theme.isDarkTheme ? '#0f0f0f' : '#f8fafc'};
`
...
export const GamingVideoTitle = styled.p`
    font-family: 'Roboto';
    font-size: 18px;
    color: ${props => (props.theme.isDarkTheme ? '#ffffff' : '#181818')};
    margin-bottom: 0px;
`
...
export const GamingViewsCount = styled.p`
    font-family: 'Roboto';
    font-size: 14px;
    color: ${props => (props.theme.isDarkTheme ? '#d7dfe9' : '#313131')};
    margin-right: 20px;
`
